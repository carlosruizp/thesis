...
%\begin{center}
    \begin{longtable}{
        ...
        \caption[\acrshort{mtl} problems.]{\acrshort{mtl} problems. The columns show the number of samples $n$, the dimension $d$, the number of tasks $T$ and the nature of the problem.} \label{tab:mtl_problems} \\
    \toprule 
