...
\begin{itemize}
    ...
    \item The VC-dimension $\vcdim{\hypspace}$, or capacity, of the hypothesis space $\hypspace$, which is desirable to be small. This term is not intuitive and is the most important term in Vapnik theory.
\end{itemize}
...
\subsubsection*{Generalized VC-Dimensions for Multi-Task Learning}
...
To overcome this limitations, a generalized VC-dimension developed in~\cite{baxter2000model} for Multi-Task Learning with Boolean hypothesis.
%
...
\begin{align}
    ...
    \overline{d}(\hypspacef) &\defeq    \nonumber \\
    \underline{d}(\hypspacef) &\defeq    \nonumber
\end{align}
