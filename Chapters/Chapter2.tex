...
\begin{definition}[Primal Problem of \acrshort{svm} for Classification]
    ...
    \begin{equation}
        ...
        \begin{aligned}
            ...
            & \text{s.t.} & & l_i (\dotp{w}{\tilde{x}} + b) \geq 1 - \xi_i , \\
            & & & \xi_i \geq 0 ,      
        \end{aligned}  
    \end{equation}
...
\begin{lemma}[Unifying Formulation for \acrshort{svm}]
    ...
    \begin{equation}
        ...
        \begin{aligned}
            ...
            & \text{s.t.} & & y_i (\dotp{w}{\tilde{x}} + b) \geq p_i - \xi_i , \\
            & & & \xi_i \geq 0 ,      
        \end{aligned}  
    \end{equation}
...
\begin{equation}
    ...
    \lagr(w, b, \fv{\xi}, \fv{\alpha}, \fv{\beta}) = \sum_{i=1}^\nsamples \xi_i + \frac{1}{2} \norm{w}^2 - \sum_{i=1}^\nsamples \alpha_i \left[ y_i (\dotp{w}{\tilde{x}} + b) - p_i + \xi_i \right] - \sum_{i=1}^\nsamples \beta_i \xi_i ,
\end{equation}
%
...
\begin{align}
    ...
    \nabla_{\xi_i} \lagr(w, b, \fv{\xi}, \fv{\alpha}, \fv{\beta}) = 0 &\implies C - \alpha - \beta_i = 0 , \label{eq:lagr_diff_xi}
\end{align}
...
\end{definition}
The result is a constrained quadratic problem where the first term is quadratic and the second is linear. Algorithms like SMO
