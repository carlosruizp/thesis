...
%First they fix $\mymat{d}$ and solve for $\mymat{w}$; while in the second step, with fixed $\mymat{w}$, there exists a closed solution for $\mymat{d}^* = \left(\mymat{w}^\intercal \mymat{w}\right)^\frac{1}{2} / \Tr\left( \left(\mymat{w}^\intercal \mymat{w}\right)^\frac{1}{2} \right)$.
...
\comm{TODO: explicación de tabla}
...
%     \begin{tabular}{*{6}{l}}
%     \toprule
%     \fhead{Name} & \fhead{Size} & \fhead{Dim} & \fhead{$T$} & \fhead{Goal} & \fhead{References} \\
%     \midrule
%     % \fdata{school} & 15362 & 27 & 139  & 1 \\ 
%     \multirow{11}{*}{\fdata{school}} & \multirow{11}{*}{15362} & \multirow{11}{*}{27} & \multirow{11}{*}{139} & \multirow{11}{*}{single-reg}  & \multirow{9}{*}{}~\cite{EvgeniouP04} \\ &&&&&~\cite{EvgeniouMP05} \\ &&&&&~\cite{ArgyriouEP06,ArgyriouMPY07,ArgyriouEP08} \\ &&&&&~\cite{BonillaCW07} \\ &&&&&~\cite{ZhangY10}  \\ &&&&&~\cite{AgarwalDG10}  \\ &&&&&~\cite{ChenZY11}   \\ &&&&&~\cite{ZhouCY11} \\ &&&&&~\cite{GongYZ12rmfl} \\ &&&&&~\cite{KumarD12}  \\ &&&&&~\cite{ZhangY13a}  \\ [3.0ex]
...
%     \multirow{5}{*}{\fdata{computer}} & \multirow{5}{*}{3600} & \multirow{5}{*}{13} & \multirow{5}{*}{180} & \multirow{5}{*}{single-reg}  & \multirow{5}{*}{}~\cite{ArgyriouEP06,ArgyriouMPY07,ArgyriouEP08} \\ &&&&&~\cite{EvgeniouMP05}  \\ &&&&&~\cite{AgarwalDG10} \\ &&&&&~\cite{KumarD12} \\ [3.0ex]
...
%     \multirow{4}{*}{\fdata{sentiment}} & \multirow{4}{*}{2000} & \multirow{4}{*}{473856} & \multirow{4}{*}{4} & \multirow{4}{*}{bin-clas}  & \multirow{4}{*}{}~\cite{Daume09} \\ &&&&&~\cite{ZhangY10} \\ &&&&&~\cite{CrammerM12} \\ &&&&&~\cite{ZhangY13a} \\ [3.0ex]
%     \multirow{5}{*}{\fdata{sarcos}} & \multirow{5}{*}{44484} & \multirow{5}{*}{21} & \multirow{5}{*}{7} & \multirow{5}{*}{multi-reg}  & \multirow{5}{*}{}~\cite{ZhangY10} \\ &&&&&~\cite{ChenZY11} \\ &&&&&~\cite{ZhouCY11} \\ &&&&&~\cite{JawanpuriaN12} \\ &&&&&~\cite{ZhangY13a} \\ [3.0ex]
%     \multirow{3}{*}{\fdata{isolet}} & \multirow{3}{*}{7797} & \multirow{3}{*}{617} & \multirow{3}{*}{5} & \multirow{3}{*}{MT multi-clas}  & \multirow{3}{*}{}~\cite{ParameswaranW10} \\ &&&&&~\cite{GongYZ12} \\ &&&&& - \\ [3.0ex]
...
%     \multirow{3}{*}{\fdata{mnist}} & \multirow{3}{*}{70000} & \multirow{3}{*}{400} & \multirow{3}{*}{10} & \multirow{3}{*}{multi-clas}  & \multirow{3}{*}{}~\cite{KangGS11} \\ &&&&&~\cite{KumarD12} \\ &&&&&~\cite{ZweigW13} \\ [3.0ex]
%     \multirow{3}{*}{\fdata{usps}} & \multirow{3}{*}{9298} & \multirow{3}{*}{256} & \multirow{3}{*}{10} & \multirow{3}{*}{multi-clas}  & \multirow{3}{*}{}~\cite{KangGS11} \\ &&&&&~\cite{KumarD12} \\ &&&&&~\cite{ZweigW13} \\ [3.0ex]
...
\subsection{Operator-Valued Kernel Hilbert Spaces}%Single-Task Learning with MTL Kernels}
...
\comm{TODO: completar, comprobar que los funcionales de evaluación están acotados y que todo está bien definido}\\
