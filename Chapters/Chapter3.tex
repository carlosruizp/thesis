...
\subsection{How to define Multi-Task kernels for regularized learning}
...
Most MTL strategies used in deep learning can be categorized as Feature-Based, but given its relevance, MTL with neural networks will be treated separately. 
...
The concept of Multi-Task problem is not clear, since different authors consider different definitions. 
