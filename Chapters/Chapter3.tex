...
\end{equation}
The optimization with respect the network parameters is done using back-propagtion, while the optimization with respect to $\fm{U}$ uses a specific algorithm.
