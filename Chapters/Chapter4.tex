...
%
% The proposal of~\cite{RuizAD19} is made for L1-\acrshort{svm}, but it is extended to L2 and LS-\acrshort{svm}s in~\cite{RuizAD21}. In this section we present the convex formulation for L1, L2 and LS-\acrshort{svm}, as well as the equivalence results between the {additive} and {convex} formulations.




\subsection{L1-\acrshort{svm} and Equivalence Results}\label{subsec:cvx_l1-svm}
