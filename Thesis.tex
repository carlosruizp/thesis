...
\newacronym{nwps}{NWPs}{Numerical Weather Predictions}
...
%\addtocontents{toc}{\vspace{1em}}  % Add a gap in the Contents, for aesthetics
\addtocontents{toc}{}  % Add a gap in the Contents, for aesthetics
First, I want to thank my Ph.D. supervisors, Professor José R. Dorronsoro and Professor Carlos M. Alaíz, who have guided me with great expertise and wise advices throughout my research. I am immensely grateful for their invaluable help, but also for their kindness.

I would like to express my gratitude to Professor Johan Suykens, for his assistance and insightful comments.

I also want to thank my fellow Ph.D students, Carlos Ramos, David Díaz, Eduardo Garrido and Alejandro Catalina, for their guidance and discussions. I express my gratitude to my friend Arun Pandey, who was an inestimable help during my stay in Leuven.
\newline
\newline
I also acknowledge all the members of the committee and official readers of this thesis. I am grateful as well to the KU Leuven University, particulary to the ESAT group, for receiving me in my research visit. I would like to mention all the staff from the Instituto de Ingenería del Conocimiento (IIC) and the Department of Computer Sciences at Universidad Autónoma de Madrid, in particular to the Machine Learning Group.

This research would have not been possible without the support of the Spain’s grant TIN2016-76406-P and the European Regional Development Fund and the Spanish State Research Agency of the Ministry of Economy, Industry, and Competitiveness under the project PID2019-106827GB-I00.
I also acknowledge the UAM-ADIC Chair for Data Science and Machine Learning for their support.
I thank Red El\'ectrica de España for making available solar energy data and the Agencia Estatal de Meteorologı\'ia, AEMET, and the ECMWF for access to the MARS repository. 
I also gratefully acknowledge the use of the facilities of Centro de Computaci\'on Cient\'ifica (CCC) at UAM.
\newline
\newline
I dedicate my deepest gratitude to my family, who has always supported me.

Finally, I am deeply grateful to all my friends, but particularly to Sara, Javier, Elena and Cristina, who have accompanied me throughout this journey.
