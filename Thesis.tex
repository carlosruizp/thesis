...
\input{./Chapters/Chapter2} % Foundations and Concepts

\input{./Chapters/Chapter3} % Multi-Task Learning Overview

\input{./Chapters/Chapter4} % Convex Multi-Task SVM

\input{./Chapters/Chapter5} % Adaptive Graph Laplacian Multi-Task Learning SVM
