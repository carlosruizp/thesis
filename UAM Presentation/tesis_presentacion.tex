...
\begin{frame}
      {Riesgo Esperado}
      \begin{itemize}
            \item Dado un espacio de hipótesis $\hypspace$
            \item Riesgo Esperado:
            \begin{myequation}
                  \nonumber
...
\begin{frame}
      ...
      \begin{itemize}
            \item Ahora tenemos una muestra multitarea:
            \begin{myequation}
                  \nonumber
...
\begin{frame}
      ...
      \begin{itemize}
          \item Proponemos en~\footfullcite{RuizAD19} la siguiente formulación convexa para el aprendizaje multitarea:
          \begin{myequation}
            \nonumber
      ...
      %     \end{itemize}
          \item Extendemos esta formulación en~\footfullcite{RuizAD21} y desarrollamos tres variantes de SVM:
          \begin{itemize}
                \item L1-SVM
                \item L2-SVM
                \item LS-SVM
...
\begin{frame}
      ...
      \begin{itemize}
            \item Consideramos en~\footfullcite{RuizAD21} la combinación convexa de
            \begin{itemize}
...
\begin{frame}
      ...
      \begin{itemize}
            \item En todos los casos lo podemos expresar como
            \begin{myequation}
                  \nonumber
                  \emprisk(\lambda_1, \ldots, \lambda_\ntasks) =
...
\begin{frame}
      ...
      \begin{itemize}
            \item Proponemos en~\footfullcite{RuizAD22_hais} la formulación convexa para redes neuronales MT, combinando:
            \begin{itemize}
...
\begin{frame}
      ...
      \begin{itemize}
            \item En~\footfullcite{RuizAD20} proponemos combinar la formulación convexa con la regularización Laplaciana
...
\begin{frame}
      ...
      \begin{itemize}
            ...
            \item En~\footfullcite{RuizAD21_hais} proponemos un método para la selección automática de $A$
      ...
      \centering
          ...
          \begin{tabular}{l*{5}{c}}
            ...
            %& \multicolumn{3}{c}{Tarea Real 1} \\
              ...
              \midrule
               \multirow{3}{*}{\fdata{regClusters0}, \fdata{clasClusters0}} & \multirow{3}{*}{2} & $f_1(x) = x^2$ & 2 & \multirow{3}{*}{7}\\
               & & $f_2(x) = \sin(10x)$ & 3 & \\ 
             & & $f_3(x) = x^3$ & 2  & \\ 
             \midrule
